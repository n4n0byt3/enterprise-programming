...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-submit:hover { background: #a86e1e; }
        ...
        <form action="add-book" method="post" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <input type="text" name="genres" maxlength="255" required
                       ...
                       value="<%= request.getAttribute("genres") != null ? request.getAttribute("genres") : "" %>">
            </div>

            <div class="form-group">
                <label>Characters</label>
                <textarea name="characters" placeholder="Comma-separated character names (optional)"><%= request.getAttribute("characters") != null ? request.getAttribute("characters") : "" %></textarea>
            </div>

            <div class="form-group">
                <label>Synopsis</label>
                <textarea name="synopsis" style="min-height:120px;" placeholder="Brief synopsis (optional)"><%= request.getAttribute("synopsis") != null ? request.getAttribute("synopsis") : "" %></textarea>
            </div>
...
<script>
    // Client-side validation — mirrors server-side rules in AddBookServlet.java
